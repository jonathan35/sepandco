...
$resize_width['background'] = 400;
$resize_height['background'] = 250;
...
$type['id'] = 'hidden';
$remark['background'] = '<div><small class="text-muted" >Recommanded size: 400 x 250 pixel</small></div>';
...
*/
$cols = $items =array();
$cols = array('Block Text' => 3, 'Background Image' => 3, 'Position' => 6);//Column title and width
